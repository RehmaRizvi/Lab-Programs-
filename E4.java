...
class NQueenSolution
{
    ...
    static boolean solveNQueen()
    {
        ...
        System.out.println("Enter the value of N for NxN chess board:\t");
        int n = sc.nextInt();
    ...
    {
        NQueenSolution obj = new NQueenSolution();

        //Setting Start and End Timer to obtain executing time for the program for N(given) queens
        long start2 = System.currentTimeMillis();
        obj.solveNQueen();
        long end2 = System.currentTimeMillis();
        System.out.println("\n\nTotal Time taken to execute in milli seconds: "+ (end2-start2));
    }
}
